...
const Navbar = () => {
    return (
        <>
            <header className="bg-slate-600  md:p-4 " >
                <div className="logo flex justify-between p-2 mx-auto relative lg:w-8/12">
                    ...
                    <nav className="hidden flex-col p-4 right-0 top-0 text-center  absolute w-7/12 h-72 justify-center bg-primaryLight shadow-sm lg:flex md:flex-row md:bg-inherit md:w-12/12 md:p-0 md:h-max">
                        ...
                        <p className="text-text-primary font-bold text-xl mb-4 md:mr-6 p-2 hover:bg-slate-300 md:mb-0"><Link to="/">Projects</Link></p>
